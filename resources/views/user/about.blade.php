...
<body>
    ...
    <section class="about-section">
        <div class="container">
            <h2>Our Mission</h2>
            <p>At Venue Sathi, our mission is to revolutionize the way people find and book venues. We aim to provide a seamless platform where users can discover affordable venues in their desired locations, making event planning easier and more accessible for everyone.</p>
            <h2>Who We Are</h2>
